...
class WPSEO_Replace_Vars {
	...
	/**
	 * Retrieve the string generated by get_the_entertainment_title().
	 *
	 * @return string|null
	 */
	private function retrieve_entertainment_title() {
		return get_the_entertainment_title();
	}
	...
	private static function set_basic_help_texts() {
		...
		$replacement_variables = [
			...
			new WPSEO_Replacement_Variable( 'entertainment_title', __( 'entertainment title', 'wordpress-seo' ), __( 'Replaced with the normal title for an entertainment generated by WordPress', 'wordpress-seo' ) ),
