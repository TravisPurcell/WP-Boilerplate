...
class WPSEO_Replace_Vars {
	...
	/**
	 * Retrieve the string generated by get_the_boiler_title().
	 *
	 * @return string|null
	 */
	private function retrieve_boiler_title() {
		return get_the_boiler_title();
	}
	...
	private static function set_basic_help_texts() {
		...
		$replacement_variables = [
			...
			new WPSEO_Replacement_Variable( 'boiler_title', __( 'boiler title', 'wordpress-seo' ), __( 'Replaced with the normal title for an boiler generated by WordPress', 'wordpress-seo' ) ),
