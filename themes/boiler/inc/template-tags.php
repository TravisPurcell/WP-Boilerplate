...
if ( ! function_exists( 'boiler_posted_on' ) ) :
	...
	function boiler_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'boiler' ),
...
if ( ! function_exists( 'boiler_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function boiler_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'boiler' ),
...
if ( ! function_exists( 'boiler_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function boiler_entry_footer() {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space after the comma */
			$categories_list = get_the_category_list( esc_html__( ', ', 'boiler' ) );
			if ( $categories_list ) {
				/* translators: 1: list of categories. */
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'boiler' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}

			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'boiler' ) );
			if ( $tags_list ) {
				/* translators: 1: list of tags. */
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'boiler' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'boiler' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'boiler' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'boiler_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function boiler_post_thumbnail() {
...
/* Hero
-------------------------------------*/
function boiler_hero() { ?>
	<div class="row top d-none d-md-block">
		<div class="col-7 col-md-3 logo--align">
			<a aria-label="Go to homepage" href="/boiler/126"><img src="<?php echo get_stylesheet_directory_uri() . '/dist/images/logo.svg'; ?>" class="d-none d-md-block img-fluid" alt="boiler Investment Partners Logo"></a>
		</div>
...
-------------------------------------*/
function boiler_secondary_intro() { ?>
...
-------------------------------------*/
function boiler_secondary_banner_events_repeater() { 
...
-------------------------------------*/
function boiler_secondary_list_repeater() { ?>
...
-------------------------------------*/
function boiler_secondary_events() { ?>
...
-------------------------------------*/
function boiler_secondary_upcoming_financial() { ?>
...
-------------------------------------*/
function boiler_secondary_on_demand_content() { ?>
...
-------------------------------------*/
function boiler_image_text_block() { ?>
...
-------------------------------------*/
function boiler_image_text_block_2() { ?>
...
-------------------------------------*/
function boiler_image_text_block_3() { ?>
	<div class="row full-width">
...
/*  Image Text Block 
-------------------------------------*/
function boiler_mid_image_text_block() { ?>
...
-------------------------------------*/
function boiler_full_width_calculator() { ?>
	<div class="row full-width">
		<div class="col-12 col-md-6" style="padding: 0">
			...
			<div class="row flex">
				<?php if( have_rows('team_content') ):
					...
					<div class="col bg-g" style="padding: 0">
						...
						<!-- <p><a class="btn btn--dblue" href="mailto:<?php the_sub_field('email'); ?>?subject=Inquiry%20from%20the%20boiler%20Investment%20Partners." target="_blank"><?php the_sub_field('button_text'); ?></a></p> -->
						<div class="text-wrapper">
							...
							<p><strong>Email:<br class="d-md-block d-lg-none"></strong> <a style="color: #003C71" href="mailto:<?php the_sub_field('email'); ?>?subject=Inquiry%20from%20the%20boiler%20Investment%20Partners."><?php the_sub_field('email'); ?></a></p>
						</div>
						<div class="img-wrapper">
...
function boiler_financial_services() { ?>
...
/* Flexible Content 
-------------------------------------*/
function boiler_flexible_content() { 
	if( have_rows('module') ):
