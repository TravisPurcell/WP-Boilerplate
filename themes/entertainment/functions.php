...
function entertainment_setup() {
	...
	register_nav_menus( array(
		'desktop_main' => esc_html__( 'Main Menu - Desktop', 'entertainment' ),
		'header' => esc_html__( 'Header', 'entertainment' ),
		'secondary' => esc_html__( 'Secondary Menu', 'entertainment' ),
		'footer' => esc_html__( 'Footer', 'entertainment' ),
		'sidebar' => esc_html__( 'Sidebar', 'entertainment' ),
		'sidebar-single' => esc_html__( 'Sidebar (Single)', 'entertainment' ),
		'sidebar-locations' => esc_html__( 'Sidebar (Locations)', 'entertainment' )
	) );
